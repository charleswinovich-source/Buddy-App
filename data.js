...
const ROLE_DATA = {
  ...
  product: {
    name: 'Product',
    icon: '🎯',
    desc: 'Feature requests, usage analytics, roadmap evidence, releases',
    subroles: ['Product Manager', 'Product Lead', 'Product Analyst', 'Technical PM'],
    focusAreas: [
      {
        id: 'feature-requests', name: 'Feature Requests', icon: '📥',
        desc: 'What customers are asking for, ARR backing, frequency',
        actions: [
          { title: 'What are customers requesting most that we have not built yet?', category: 'question', type: 'ask', meta: 'Jira + Zendesk + Gong', tags: ['jira','zendesk','gong'], multi: true, semantic: true, top: true, rising: false },
          { title: 'Which feature requests come from our highest ARR accounts?', category: 'question', type: 'ask', meta: 'Salesforce + Jira + Gong', tags: ['salesforce','jira','gong'], multi: true, semantic: true, top: true, rising: false },
          { title: 'How many times has feature X been requested across all channels?', category: 'question', type: 'ask', meta: 'Gong + Zendesk + Jira + Slack', tags: ['gong','zendesk','jira','slack'], multi: true, semantic: true, top: true, rising: false },
          { title: 'Weekly feature request digest from Zendesk, Gong, and Jira to Slack', category: 'automation', type: 'auto', meta: 'Jira + Gong + Zendesk + Slack', tags: ['jira','gong','zendesk','slack'], multi: true, semantic: true, top: true, rising: false },
          { title: 'Generate a prioritized feature request report ranked by ARR and frequency', category: 'generator', type: 'ask', meta: 'Jira + Salesforce + Gong + Zendesk', tags: ['jira','salesforce','gong','zendesk'], multi: true, semantic: true, top: false, rising: true },
        ]
      },
      {
        id: 'usage-adoption', name: 'Usage & Adoption', icon: '📈',
        desc: 'Feature usage, activation funnels, engagement trends',
        actions: [
          { title: 'Which features have declining weekly active usage?', category: 'question', type: 'ask', meta: 'Amplitude', tags: ['amplitude'], multi: false, semantic: false, top: true, rising: false },
          { title: 'What is our activation funnel by onboarding path and segment?', category: 'question', type: 'ask', meta: 'Amplitude + Salesforce', tags: ['amplitude','salesforce'], multi: true, semantic: true, top: true, rising: false },
          { title: 'DAU/MAU trends segmented by customer tier and plan', category: 'question', type: 'ask', meta: 'Amplitude + Salesforce', tags: ['amplitude','salesforce'], multi: true, semantic: true, top: true, rising: false },
          { title: 'Push weekly feature adoption report to product Slack channel', category: 'automation', type: 'auto', meta: 'Amplitude + Slack', tags: ['amplitude','slack'], multi: true, semantic: false, top: true, rising: false },
          { title: 'How does feature usage correlate with contract renewal and expansion?', category: 'question', type: 'ask', meta: 'Amplitude + Salesforce', tags: ['amplitude','salesforce'], multi: true, semantic: true, top: false, rising: true },
        ]
      },
      {
        id: 'customer-pain', name: 'Customer Pain', icon: '🔥',
        desc: 'Support themes, churn signals, NPS verbatims',
        actions: [
          { title: 'What are the top pain themes in support tickets this month?', category: 'question', type: 'ask', meta: 'Zendesk', tags: ['zendesk'], multi: false, semantic: true, top: true, rising: false },
          { title: 'Which accounts are showing churn signals based on usage and support?', category: 'question', type: 'ask', meta: 'Amplitude + Zendesk + Salesforce', tags: ['amplitude','zendesk','salesforce'], multi: true, semantic: true, top: true, rising: false },
          { title: 'Pull every NPS detractor verbatim about data reliability', category: 'question', type: 'ask', meta: 'Zendesk + Gainsight', tags: ['zendesk','gainsight'], multi: true, semantic: true, top: true, rising: false },
          { title: 'Alert me when a new pain theme spikes in support tickets', category: 'automation', type: 'auto', meta: 'Zendesk + Slack', tags: ['zendesk','slack'], multi: true, semantic: true, top: false, rising: true },
          { title: 'Generate a customer pain summary synthesizing support, calls, and NPS', category: 'generator', type: 'ask', meta: 'Zendesk + Gong + Gainsight', tags: ['zendesk','gong','gainsight'], multi: true, semantic: true, top: true, rising: true },
        ]
      },
      {
        id: 'roadmap-evidence', name: 'Roadmap Evidence', icon: '📋',
        desc: 'Business cases, competitive gaps, cross-source synthesis',
        actions: [
          { title: 'Total ARR represented by customers who asked for feature X', category: 'question', type: 'ask', meta: 'Gong + Zendesk + Salesforce', tags: ['gong','zendesk','salesforce'], multi: true, semantic: true, top: true, rising: false },
          { title: 'Find every customer who mentioned feature X in calls or tickets', category: 'question', type: 'ask', meta: 'Gong + Zendesk + Jira', tags: ['gong','zendesk','jira'], multi: true, semantic: true, top: true, rising: false },
          { title: 'What are competitors shipping that we are missing?', category: 'question', type: 'ask', meta: 'Gong + Jira', tags: ['gong','jira'], multi: true, semantic: true, top: false, rising: true },
          { title: 'Generate a business case doc with customer quotes, ARR, and usage data', category: 'generator', type: 'ask', meta: 'Gong + Zendesk + Salesforce + Amplitude', tags: ['gong','zendesk','salesforce','amplitude'], multi: true, semantic: true, top: true, rising: true },
          { title: 'Build a full retention risk picture from all available signals', category: 'generator', type: 'ask', meta: 'Amplitude + Salesforce + Zendesk + Gainsight', tags: ['amplitude','salesforce','zendesk','gainsight'], multi: true, semantic: true, top: true, rising: false },
        ]
      },
      {
        id: 'release-tracking', name: 'Release Tracking', icon: '🚀',
        desc: 'Launch readiness, rollout metrics, adoption curves',
        actions: [
          { title: 'What is the adoption curve for our most recent feature launch?', category: 'question', type: 'ask', meta: 'Amplitude', tags: ['amplitude'], multi: false, semantic: false, top: true, rising: false },
          { title: 'Are there new support tickets related to the latest release?', category: 'question', type: 'ask', meta: 'Zendesk + Jira', tags: ['zendesk','jira'], multi: true, semantic: true, top: true, rising: false },
          { title: 'Which items have been on the backlog 6+ months with no movement?', category: 'question', type: 'ask', meta: 'Jira', tags: ['jira'], multi: false, semantic: false, top: true, rising: false },
          { title: 'Alert me when a new release causes a spike in error rates or tickets', category: 'automation', type: 'auto', meta: 'Zendesk + DataDog + Slack', tags: ['zendesk','datadog','slack'], multi: true, semantic: true, top: true, rising: false },
          { title: 'Generate a launch readiness checklist from Jira, docs, and support', category: 'generator', type: 'ask', meta: 'Jira + Zendesk', tags: ['jira','zendesk'], multi: true, semantic: true, top: false, rising: true },
        ]
      },
      {
        id: 'stakeholder-updates', name: 'Stakeholder Updates', icon: '📊',
        desc: 'Exec decks, QBR prep, metric summaries',
        actions: [
          { title: 'What are the key product metrics I need for the exec review?', category: 'question', type: 'ask', meta: 'Amplitude + Salesforce + Zendesk', tags: ['amplitude','salesforce','zendesk'], multi: true, semantic: true, top: true, rising: false },
          { title: 'Generate a weekly cross-source product health brief for leadership', category: 'generator', type: 'ask', meta: 'Amplitude + Salesforce + Zendesk + Jira', tags: ['amplitude','salesforce','zendesk','jira'], multi: true, semantic: true, top: true, rising: false },
          { title: 'Build a QBR deck with usage, NPS, feature adoption, and roadmap progress', category: 'generator', type: 'ask', meta: 'Amplitude + Jira + Zendesk + Gainsight', tags: ['amplitude','jira','zendesk','gainsight'], multi: true, semantic: true, top: true, rising: true },
          { title: 'Auto-push product metrics summary to Slack every Friday', category: 'automation', type: 'auto', meta: 'Amplitude + Jira + Slack', tags: ['amplitude','jira','slack'], multi: true, semantic: false, top: true, rising: false },
        ]
      },
    ]
  },
  ...
  support: {
    name: 'Support',
    icon: '🎧',
    desc: 'Tickets, SLAs, CSAT, escalations, knowledge base',
    subroles: ['Support Engineer', 'Support Manager', 'Support Lead', 'TAM'],
    focusAreas: [
      {
        id: 'ticket-triage', name: 'Ticket Triage', icon: '🎫',
        desc: 'Open tickets, severity, SLA risk, auto-routing',
        actions: [
          { title: 'All open tickets by severity and time in queue right now', category: 'question', type: 'ask', meta: 'Zendesk', tags: ['zendesk'], multi: false, semantic: false, top: true, rising: false },
          { title: 'Which tickets are at risk of breaching SLA in the next 2 hours?', category: 'question', type: 'ask', meta: 'Zendesk', tags: ['zendesk'], multi: false, semantic: false, top: true, rising: false },
          { title: 'What are the most common issue categories this week?', category: 'question', type: 'ask', meta: 'Zendesk', tags: ['zendesk'], multi: false, semantic: true, top: true, rising: false },
          { title: 'Auto-route tickets to the right queue based on connector and severity', category: 'automation', type: 'auto', meta: 'Zendesk', tags: ['zendesk'], multi: false, semantic: true, top: true, rising: false },
          { title: 'Flag tickets unresponded for 4+ hours to Slack', category: 'automation', type: 'auto', meta: 'Zendesk + Slack', tags: ['zendesk','slack'], multi: true, semantic: false, top: true, rising: false },
          { title: 'Generate a triage summary for the start of each shift', category: 'generator', type: 'ask', meta: 'Zendesk', tags: ['zendesk'], multi: false, semantic: true, top: false, rising: true },
        ]
      },
      {
        id: 'customer-health', name: 'Customer Health', icon: '❤️',
        desc: 'CSAT, repeat issues, escalation patterns',
        actions: [
          { title: 'CSAT score by rep, team, and ticket category this quarter', category: 'question', type: 'ask', meta: 'Zendesk', tags: ['zendesk'], multi: false, semantic: false, top: true, rising: false },
          { title: 'Which accounts have 3+ tickets in the last 30 days?', category: 'question', type: 'ask', meta: 'Zendesk + Salesforce', tags: ['zendesk','salesforce'], multi: true, semantic: false, top: true, rising: false },
          { title: 'Top themes in low CSAT verbatim feedback this month', category: 'question', type: 'ask', meta: 'Zendesk', tags: ['zendesk'], multi: false, semantic: true, top: true, rising: false },
          { title: 'Push weekly CSAT digest with low-score accounts to CSM team', category: 'automation', type: 'auto', meta: 'Zendesk + Salesforce + Slack', tags: ['zendesk','salesforce','slack'], multi: true, semantic: false, top: true, rising: false },
          { title: 'Generate a customer health report for accounts with recurring issues', category: 'generator', type: 'ask', meta: 'Zendesk + Salesforce + Gainsight', tags: ['zendesk','salesforce','gainsight'], multi: true, semantic: true, top: false, rising: true },
        ]
      },
      {
        id: 'knowledge-gaps', name: 'Knowledge Gaps', icon: '📚',
        desc: 'Missing KB articles, deflection opportunities',
        actions: [
          { title: 'Top 10 issues that could be self-served but are not', category: 'question', type: 'ask', meta: 'Zendesk', tags: ['zendesk'], multi: false, semantic: true, top: true, rising: false },
          { title: 'Which questions do customers ask that have no matching KB article?', category: 'question', type: 'ask', meta: 'Zendesk', tags: ['zendesk'], multi: false, semantic: true, top: true, rising: false },
          { title: 'Connectors with most tickets but fewest KB articles', category: 'question', type: 'ask', meta: 'Zendesk', tags: ['zendesk'], multi: false, semantic: true, top: true, rising: false },
          { title: 'Generate a draft KB article from the most common ticket resolution', category: 'generator', type: 'ask', meta: 'Zendesk', tags: ['zendesk'], multi: false, semantic: true, top: true, rising: true },
          { title: 'Weekly report on top deflection opportunities to support lead', category: 'automation', type: 'auto', meta: 'Zendesk + Slack', tags: ['zendesk','slack'], multi: true, semantic: true, top: false, rising: false },
        ]
      },
      {
        id: 'escalations', name: 'Escalations', icon: '🔺',
        desc: 'Active escalations, patterns, resolution tracking',
        actions: [
          { title: 'All escalated tickets and their current status right now', category: 'question', type: 'ask', meta: 'Zendesk', tags: ['zendesk'], multi: false, semantic: false, top: true, rising: false },
          { title: 'Which accounts have had 2+ escalations in the last 90 days?', category: 'question', type: 'ask', meta: 'Zendesk + Salesforce', tags: ['zendesk','salesforce'], multi: true, semantic: false, top: true, rising: false },
          { title: 'What are the common patterns in escalated tickets this quarter?', category: 'question', type: 'ask', meta: 'Zendesk', tags: ['zendesk'], multi: false, semantic: true, top: true, rising: false },
          { title: 'Auto-notify account owner when an enterprise ticket is escalated', category: 'automation', type: 'auto', meta: 'Zendesk + Salesforce + Slack', tags: ['zendesk','salesforce','slack'], multi: true, semantic: false, top: true, rising: false },
          { title: 'Generate an escalation summary for the weekly support review', category: 'generator', type: 'ask', meta: 'Zendesk + Salesforce', tags: ['zendesk','salesforce'], multi: true, semantic: true, top: false, rising: true },
        ]
      },
      {
        id: 'team-performance', name: 'Team Performance', icon: '📊',
        desc: 'Handle time, resolution rate, rep CSAT scores',
        actions: [
          { title: 'Average handle time and first response time by rep this month', category: 'question', type: 'ask', meta: 'Zendesk', tags: ['zendesk'], multi: false, semantic: false, top: true, rising: false },
          { title: 'Which reps have the highest resolution rate and CSAT?', category: 'question', type: 'ask', meta: 'Zendesk', tags: ['zendesk'], multi: false, semantic: false, top: true, rising: false },
          { title: 'SLA breach rate by priority and customer tier this month', category: 'question', type: 'ask', meta: 'Zendesk + Salesforce', tags: ['zendesk','salesforce'], multi: true, semantic: false, top: true, rising: false },
          { title: 'Push weekly team performance digest to support managers', category: 'automation', type: 'auto', meta: 'Zendesk + Slack', tags: ['zendesk','slack'], multi: true, semantic: false, top: true, rising: false },
          { title: 'Generate a rep coaching report highlighting strengths and gaps', category: 'generator', type: 'ask', meta: 'Zendesk', tags: ['zendesk'], multi: false, semantic: true, top: false, rising: true },
        ]
      },
      {
        id: 'proactive-support', name: 'Proactive Support', icon: '🛡️',
        desc: 'Incident impact, at-risk accounts, preemptive outreach',
        actions: [
          { title: 'Which accounts are likely to file a ticket based on recent incident?', category: 'question', type: 'ask', meta: 'PagerDuty + Salesforce + Zendesk', tags: ['pagerduty','salesforce','zendesk'], multi: true, semantic: true, top: true, rising: false },
          { title: 'Accounts with degrading health scores that have not heard from us', category: 'question', type: 'ask', meta: 'Gainsight + Salesforce', tags: ['gainsight','salesforce'], multi: true, semantic: true, top: true, rising: false },
          { title: 'Alert support team when a known issue impacts a new set of accounts', category: 'automation', type: 'auto', meta: 'PagerDuty + Salesforce + Slack', tags: ['pagerduty','salesforce','slack'], multi: true, semantic: true, top: true, rising: false },
          { title: 'Generate a proactive outreach email for accounts impacted by an incident', category: 'generator', type: 'ask', meta: 'PagerDuty + Salesforce', tags: ['pagerduty','salesforce'], multi: true, semantic: true, top: true, rising: true },
        ]
      },
    ]
  },
