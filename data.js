    ...
    focusAreas: [
      {
        ...
        actions: [
          ...
          { title: 'Which schema changes happened upstream this week and what broke?', category: 'question', type: 'ask', meta: 'Fivetran + dbt', tags: ['fivetran', 'aisql'], multi: true, semantic: true, top: false, rising: true },
        ]
      },
      {
        ...
        actions: [
          ...
          { title: 'Downstream models that broke after last schema change', category: 'question', type: 'ask', meta: 'dbt + Fivetran', tags: ['aisql', 'fivetran'], multi: true, semantic: true, top: true, rising: false },
          ...
          { title: 'Generate a data quality scorecard for the weekly data team review', category: 'generator', type: 'ask', meta: 'Snowflake + dbt + Fivetran', tags: ['snowflake', 'aisql', 'fivetran'], multi: true, semantic: true, top: false, rising: true },
        ]
      },
      {
...
const TAG_COLORS = {
  ...
  dbt: { bg: '#fef3c7', text: '#92400e', label: 'aisql' },
  ...
  'aisql': { bg: '#fce4ec', text: '#c2185b', label: 'Culture Amp' },
  ...
  'aisql': { bg: '#e8f5e9', text: '#2e7d32', label: 'Google Ads' },
